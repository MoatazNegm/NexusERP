        ...
        <div ref={invoiceTemplateRef} className="bg-white p-12 text-slate-900" style={{ width: '800px', minHeight: '1100px', fontVariantLigatures: 'none' }}>
          ...
          <div className="grid grid-cols-2 gap-8 mb-10">
            <div className="border-2 border-slate-900 divide-y-2 divide-slate-900">
              <div className="grid grid-cols-3"><div className="col-span-1 p-3 bg-slate-50 border-r-2 border-slate-900 font-bold text-xs text-right">Customer:</div><div className="col-span-2 p-3 font-black text-sm uppercase">{order.customerName}</div></div>
              <div className="grid grid-cols-3"><div className="col-span-1 p-3 bg-slate-50 border-r-2 border-slate-900 font-bold text-xs text-right">Invoice No:</div><div className="col-span-2 p-3 font-mono font-black text-blue-600 text-xs">{order.invoiceNumber || 'DRAFT'}</div></div>
            </div>
            <div className="border-2 border-slate-900 divide-y-2 divide-slate-900">
          ...
          <div className="flex items-center gap-3">
            {showInvoiceButton && (
              <button
                ...
                className="px-6 py-3 bg-blue-600 text-white rounded-xl text-[10px] font-black uppercase shadow-lg shadow-blue-200 hover:bg-blue-700 transition-all flex items-center gap-2"
              >
                {isDownloading ? <i className="fa-solid fa-circle-notch fa-spin"></i> : <i className="fa-solid fa-file-invoice-dollar"></i>}
