    ...
    <div className="max-w-[1200px] mx-auto pb-12 space-y-6">
      ...
      {activeTab === 'new' ? (
        <div className="animate-in fade-in duration-500">
          {editStatus.type !== 'new' && (
            <div className={`mb-6 p-4 rounded-2xl border-l-[8px] flex items-center justify-between shadow-lg ${
              editStatus.type === 'frozen' ? 'bg-rose-50 border-rose-600 text-rose-800' : 'bg-amber-50 border-amber-400 text-amber-800'
            }`}>
          ...
          {message && (
            <div className={`mb-6 p-4 rounded-2xl border flex items-center gap-3 animate-in slide-in-from-top-4 ${
