...
export const APP_VERSION = '1.0000631';
...
export const INITIAL_CONFIG: AppConfig = {
  ...
  settings: {
    ...
    ledgerAccounts: [
      'Transportation', 'Ekramya', 'Handles',
      'اتعاب محاسبة', 'اتعاب محاماة', 'عمولة', 'تليفون ونظافة', 'ادوات كتابية', 'انتقالات', 'مبيت', 'ضيافة', 'اخرى', 'ايجارات', 'مرتبات', 'اكراميات', 'مصاريف بنكية', 'نقل بضاعة', 'اشتراكات', 'بوفيه', 'مصاريف ترخيص', 'رسوم سدد ضرائب / تامينات', 'منحة', 'ملابس ومستلزمات', 'نت', 'غاز', 'مياه',
      'حساب الخزينة', 'حساب بنك قطر الاهلي الوطني', 'حساب اصول ثابته', 'حساب ضريبة القيمة المضافة', 'حساب الخصم تحت حساب الضريبة', 'حساب المشتريات', 'حساب اقرارات الضرائب', 'حساب دائنون متنوعون', 'حساب دفعات مقدمة', 'حساب مقدم ايجار', 'حساب مدينون متنوعون', 'حساب العهده', 'حساب سلف مؤقته', 'حساب ايرادات اخرى',
      'حساب دكتور محمد نجم', 'حساب المهندس طارق ابو العلا', 'حساب المهندس حسن حافظ',
      'يونليفير مشرق - الفا', 'يونليفير مشرق - المصنع', 'يونليفير مشرق - مطبوعات', 'يونليفيرباعشن للصناعات الغذائية', 'السعودية للاملاح',
      'شركة بيان', 'شركة رؤوف جاد جرجس', 'شركة فور باكينج', 'شركة سكرين برنت'
    ],
    ledgerAccountGroups: {
      'Operating Expenses': ['Transportation'],
      'Supplier Payments': ['Ekramya'],
      'Employee Costs': ['Handles'],
      'حساب مصاريف الادارية': [
        'اتعاب محاسبة', 'اتعاب محاماة', 'عمولة', 'تليفون ونظافة', 'ادوات كتابية', 'انتقالات', 'مبيت', 'ضيافة', 'اخرى', 'ايجارات', 'مرتبات', 'اكراميات', 'مصاريف بنكية', 'نقل بضاعة', 'اشتراكات', 'بوفيه', 'مصاريف ترخيص', 'رسوم سدد ضرائب / تامينات', 'منحة', 'ملابس ومستلزمات', 'نت', 'غاز', 'مياه'
      ],
      'حساب الخزينة': ['حساب الخزينة'],
      'حساب بنك قطر الاهلي الوطني': ['حساب بنك قطر الاهلي الوطني'],
      'حساب اصول ثابته': ['حساب اصول ثابته'],
      'حساب ضريبة القيمة المضافة': ['حساب ضريبة القيمة المضافة'],
      'حساب الخصم تحت حساب الضريبة': ['حساب الخصم تحت حساب الضريبة'],
      'حساب المشتريات': ['حساب المشتريات'],
      'حساب اقرارات الضرائب': ['حساب اقرارات الضرائب'],
      'حساب دائنون متنوعون': ['حساب دائنون متنوعون'],
      'حساب دفعات مقدمة': ['حساب دفعات مقدمة'],
      'حساب مقدم ايجار': ['حساب مقدم ايجار'],
      'حساب مدينون متنوعون': ['حساب مدينون متنوعون'],
      'حساب العهده': ['حساب العهده'],
      'حساب سلف مؤقته': ['حساب سلف مؤقته'],
      'حساب ايرادات اخرى': ['حساب ايرادات اخرى'],
      'حساب جاري الشركاء': [
        'حساب دكتور محمد نجم',
        'حساب المهندس طارق ابو العلا',
        'حساب المهندس حسن حافظ'
      ],
      'حساب العملاء': [
        'يونليفير مشرق - الفا',
        'يونليفير مشرق - المصنع',
        'يونليفير مشرق - مطبوعات',
        'يونليفيرباعشن للصناعات الغذائية',
        'السعودية للاملاح'
      ],
      'حساب المبيعات': [
        'يونليفير مشرق - الفا',
